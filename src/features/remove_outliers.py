...
df[numerical_columns[:3] + ['label']].boxplot(by='label',
                                              figsize = (20,10),
                                              layout =(1,3))
...
df[numerical_columns[:3] + ['label']].plot.hist(by='label',
                                              figsize = (20,20),
                                              layout =(3,3))
...
dataset, outliers, X_scores = mark_outliers_lof(df[df['label']== label], numerical_columns)
for col in numerical_columns :
    plot_binary_outliers(dataset = dataset ,
                         col = col, 
                         outlier_col = 'outlier_lof',
...
dataset[dataset['acc_x_outlier']==True]

dataset.loc[dataset['acc_x_outlier'],'acc_x'] = np.nan
...
for col in numerical_columns:
    for label in df['label'].unique():
        ...
        print(f'Outliers removed for {label} in {col} = {n_outliers}')
